...
template <typename Type>
Sorted_single_list<Type>::Sorted_single_list() : list_head(nullptr),
												 list_tail(nullptr),
												 list_size(0)
{
...
template <typename Type>
Sorted_single_list<Type>::Sorted_single_list(Sorted_single_list<Type> const &list) : list_head(nullptr),
																					 list_tail(nullptr),
																					 list_size(0)
{
