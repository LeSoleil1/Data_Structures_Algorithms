...
Dynamic_deque_as_array::Dynamic_deque_as_array(int n) :
		...
		count(0) {
		// empty
		// C4 - you can choose to give initial values to ihead and itail here
		// or  you can do it when you insert the first element
